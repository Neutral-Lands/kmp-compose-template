...
class ComplianceLogLocalDataSourceTest {
    ...
    @Test
    fun `given inserted log when getByPatientAndDate then returns log`() =
        runTest {
    ...
    @Test
    fun `given no logs when getByPatientAndDate then returns empty list`() =
        runTest {
    ...
    @Test
    fun `given unsynced log when getUnsynced then includes it`() =
        runTest {
    ...
    @Test
    fun `given no logs when getUnsynced then returns empty`() =
        runTest {
            dataSource.getUnsynced().test {
                assertTrue(awaitItem().isEmpty())
                cancelAndIgnoreRemainingEvents()
    ...
    @Test
    fun `given unsynced log when markAsSynced then getUnsynced excludes it`() =
        runTest {
    ...
    @Test
    fun `given log with null note when retrieved then note is null`() =
        runTest {
    ...
    @Test
    fun `given log with note when retrieved then note is preserved`() =
        runTest {
    ...
    @Test
    fun `given FOLLOWED status when inserted and retrieved then status is FOLLOWED`() =
        runTest {
    ...
    @Test
    fun `given MISSED status when inserted and retrieved then status is MISSED`() =
        runTest {
    ...
    @Test
    fun `given PARTIAL status when inserted and retrieved then status is PARTIAL`() =
        runTest {
    ...
    @Test
    fun `given multiple logs for same patient on same date when retrieved then returns all`() =
        runTest {
